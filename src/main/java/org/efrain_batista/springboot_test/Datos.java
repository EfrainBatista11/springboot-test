...
public class Datos {
   ...
   // public static final Cuenta CUENTA_001 = new Cuenta(1L, "Efraín", new BigDecimal("1000"));
   ...
   // public static final Banco BANCO = new Banco(1L, "Banco Nacional", 0);
    ...
    public static Optional<Cuenta>  crearCuenta001(){
        return Optional.of(new Cuenta(1L, "Efraín", new BigDecimal("1000")));
    }

    public static Optional<Cuenta> crearCuenta002(){
        return Optional.of(new Cuenta(2L, "Yeilin Corella", new BigDecimal("2000")));
    }
