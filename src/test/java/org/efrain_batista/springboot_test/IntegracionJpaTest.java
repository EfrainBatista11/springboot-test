...
public class IntegracionJpaTest {
    ...
    void testFindById(){
        ...
        assertEquals("Efraín", cuenta.orElseThrow().getPersona());
    }

    @Test
    void testFindByPersona(){
        Optional<Cuenta> cuenta = cuentaRepository.findByPersona("Efraín");
    ...
    void testSave() {
        ...
        // Una vez que se crea el objeto lo devuelve, me ahorro la segunda búsqueda
