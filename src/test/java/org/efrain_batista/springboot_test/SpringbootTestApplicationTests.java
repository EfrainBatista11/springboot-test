...
import org.efrain_batista.springboot_test.services.CuentaServiceImpl;
...
class SpringbootTestApplicationTests {
    ...
    @BeforeEach
    void setUp() {
        // Esta cambia por @MockitoBean en la clase
        // cuentaRepository = mock(CuentaRepository.class);

        // Esta también cambia por @MockitoBean en la clase
        // bancoRepository = mock(BancoRepository.class);

        // Esta cambia por @Autowired
