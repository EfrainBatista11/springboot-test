...
import static org.efrain_batista.springboot_test.Datos.*;
...
class CuentaControllerTest {
    ...
    void detalle() throws Exception {
        ...
        mvc.perform(get("/api/cuentas/1").contentType(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$.persona").value("Efraín"))
                .andExpect(jsonPath("$.saldo").value("1000"));
        // Verificamos que se use el findById de nuestro Mock
    ...
    void testListar() throws Exception {
        ...
        mvc.perform(get("/api/cuentas").contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[0].persona").value("Efraín"))
                .andExpect(jsonPath("$[1].persona").value("Yeilin Corella"))
    ...
    void testGuardar() throws Exception {
        // Given
        Cuenta cuenta = new Cuenta(null, "Mateo", new BigDecimal("3000"));
        ...
        mvc.perform(post("/api/cuentas").contentType(MediaType.APPLICATION_JSON)
                ...
                .andExpect(jsonPath("$.persona", is("Mateo")))
